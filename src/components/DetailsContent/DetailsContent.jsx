  ...
  return (
    <div className="details">
      ...
      <div className="right-home">
        <div className="title">{candle && candle.candleName? candle.candleName:"candleName"}</div>
        <div className="Info">
          <div className="purchase">
            <div className="price">$ {candle && candle.price? candle.price:"9.99"}</div>
            <div className="one">
            <div className="input">
...
: {candle && candle.fragrance? candle.fragrance:"Premium quality ingredients with natural essential oils "} </div>
<div className="ligne3"><span><span className="span">
  Burning Time</span>: {candle && candle.burningTime? candle.burningTime:"70-75 hours"}</span>
<span><span className="span">Dimension</span>: {candle && candle.dimension? candle.dimension:"10cm x 5cm"} </span>
<span> <span className="span">Weight</span>: {candle && candle.weight? candle.weight:"400g"}</span> </div>
          </div>
        </div>
      </div>
    </div>
